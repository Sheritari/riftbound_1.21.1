...
public final class LootEvents {
    ...
    public static void onLivingDrops(LivingDropsEvent event) {
        ...
        int itemLevel = Math.max(1, entity.blockPosition().getY() / 6);
        ...
        if (bladeRoll < 0.08F) {
            ItemRarity rarity = bladeRoll < 0.03F ? ItemRarity.MAGIC : ItemRarity.NORMAL;
            ItemStack blade = LootItemFactory.createShardBlade(random, itemLevel, rarity, serverLevel.registryAccess());
